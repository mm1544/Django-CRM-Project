...
def clients_export(request):
    # Will loop through all Clients and will add them to csv file
...
def clients_delete(request, pk):
    ...
    messages.success(request, 'The client "{}" was deleted.'.format(client.name))
...
def clients_edit(request, pk):
    ...
    if request.method == 'POST':
        # (!!!) Need to pass 'instance=client' so that DJ knows that we want to update the information, but NOT creating a ned client.
