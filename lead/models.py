...
class Lead(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name='leads', on_delete=models.CASCADE) # 'CASCADE' --> When deleting User all the related leads will be DELETED.
...
class Comment(models.Model):
    ...
    # When Lead is deleted, then the Comment is deleted as well(?) --> 'on_delete=models.CASCADE'
